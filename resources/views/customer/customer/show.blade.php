        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">Cliente {{ $customer->id }}</div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr><th> Nombre </th><td> {{ $customer->nombre }} </td></tr><tr><th> Apellido </th><td> {{ $customer->apellido }} </td></tr><tr><th> Documento </th><td> {{ $customer->documento }} </td></tr>
                                </tbody>
                            </table>
                        </div>
